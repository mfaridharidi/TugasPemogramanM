...
public class DataProvider {
    ...
    private static List<Buaya> initDataBuaya(Context ctx) {
        ...
        buayas.add(new Buaya("Air Tawar", "Inggris",
                "Buaya air tawar adalah buaya yang tersebar di banyak negara. Buaya ini hidup di sungai ataupun danau", R.drawable.buaya_air_tawar));
        buayas.add(new Buaya("Amerika", "Amerika",
                "Buaya Amerika adalah spesies berukuran besar dengan warna keabu-abuan dan moncong berbentuk V yang menonjol", R.drawable.buaya_amerika));
        buayas.add(new Buaya("Irian", "Pulau Nugini",
                "Buaya Irian Hall adalah yang buaya kecil yang sangat mirip dan bahkan sudah lama diklasifikasikan sebagai buaya Irian, yang sekarang dianggap berbeda secara genetis ", R.drawable.buaya_irian));
        buayas.add(new Buaya("Kalimantan", "Pulau Kalimantan",
                "Buaya Kalimantan sebenarnya adalah spesies buaya air tawar yang dianggap sama dengan buaya muara.", R.drawable.buaya_kalimantan));
        buayas.add(new Buaya(" muara", "asia tenggara",
                "buaya muara adalah reptil hidup terbesar dan paling agresif dari semua buaya. Mereka adalah spesies berkepala besar dan memiliki moncong yang relatif lebar, terutama ketika semakin tua. ", R.drawable.buaya_muara));
        buayas.add(new Buaya("mugger", "benua india",
                "Buaya Mugger adalah buaya berukuran sedang dengan moncong yang sangat lebar dan penampilan seperti aligator. Warnanya abu-abu gelap sampai coklat. Sisiknya yang membesar di sekitar leher membuatnya terlihat kekar dan menakutkan  ", R.drawable.buaya_mugger));
        return buayas;
    }
